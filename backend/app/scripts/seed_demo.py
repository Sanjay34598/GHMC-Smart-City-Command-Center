...
def seed(db) -> None:  # type: ignore[no-untyped-def]
    ...
    for idx, s in enumerate(SCENARIOS):
        ...
        incident = Incident(
           ...
           IMAGE_MAP = {
                "Road Block": "/uploads/road_block.jpg",
                "Garbage Overflow": "/uploads/garbage_overflow.jpeg",
                "Open Manholes": "/uploads/open_manhole.jpeg",
                "Building Collapse": "/uploads/building_collapse.jpeg",
                "Flood": "/uploads/flood.jpg",
                "Fire": "/uploads/fire.jpeg",
                "Accident": "/uploads/accident.jpg",
                "Illegal Parking": "/uploads/illegal_parking.jpeg",
                "Water Leakage": "/uploads/water_leak.jpg",
                "Footpath Encroachment": "/uploads/encroachment.jpeg",
                "Tree Fallen": "/uploads/tree_fallen.jpeg",
             }
            status=s["status"],
