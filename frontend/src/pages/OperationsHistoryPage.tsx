...
const historyLog = [
  ...
  { time: '08:17', action: 'Municipal Engineering Team Dispatched', source: 'Dispatcher K. Rao' },
...
const archivedIncidents: OperationsArchivalRecord[] = [
  {
    ...
    aiConfidence: '96%',
    departmentsResponded: ['Municipal Engineering', 'Emergency Response Force (ERF)', 'Traffic Police'],
  ...
  },
  {
    ...
    aiConfidence: '94%',
    departmentsResponded: ['HMWS&SB Water Works', 'Municipal Rapid Response'],
